...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem1/semester_1_subject/ppa/ppa_notes_unit_wise.dart';


class ppaSam1 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ppaSam1State();
}

class _ppaSam1State extends State<ppaSam1> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Programming principles  & Algorithm ",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold,),)),
              ),
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>PPA_Notes_Unit_Wise()));
              },),
              SizedBox(
                height: 18,
              ),
