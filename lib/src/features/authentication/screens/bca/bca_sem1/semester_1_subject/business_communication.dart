...
class BusinessCommunication extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _BusinessCommunicationState();
}

class _BusinessCommunicationState extends State<BusinessCommunication> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Business Communication ",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 28,fontWeight: FontWeight.bold,),)),
              ),
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>BC_Notes_Unit_wise() ));
              },),
              SizedBox(
                height: 18,
              ),
