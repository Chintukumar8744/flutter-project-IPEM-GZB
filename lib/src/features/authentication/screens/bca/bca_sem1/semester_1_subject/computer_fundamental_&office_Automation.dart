...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem1/semester_1_subject/computer_fundamental/cfoa_notes_unit_wise.dart';


class CFOASam1 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CFOASam1State();
}

class _CFOASam1State extends State<CFOASam1> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("C.F.O.A ",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold,),)),
              ),
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>CFOA_Notes_Unit_Wise()));
              },),
              SizedBox(
                height: 18,
              ),
