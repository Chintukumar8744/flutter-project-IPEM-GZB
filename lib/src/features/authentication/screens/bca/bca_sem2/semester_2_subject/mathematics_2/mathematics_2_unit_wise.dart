...
class Mathematics2UnitWise extends StatefulWidget {
  const Mathematics2UnitWise({super.key});

  @override
  State<Mathematics2UnitWise> createState() => _Mathematics2UnitWiseState();
}

class _Mathematics2UnitWiseState extends State<Mathematics2UnitWise> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Mathematics II",style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold),)),
              ),
