...
class FinancialAccountingUnitWise extends StatefulWidget {
  const FinancialAccountingUnitWise({super.key});

  @override
  State<FinancialAccountingUnitWise> createState() => _FinancialAccountingUnitWiseState();
}

class _FinancialAccountingUnitWiseState extends State<FinancialAccountingUnitWise> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Financial Accounting And Management",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold),)),
              ),
