...
class CProgramming extends StatefulWidget {
  const CProgramming({super.key});

  @override
  State<CProgramming> createState() => _CProgrammingState();
}
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("C programming",style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold),)),
              ),
