...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem2/semester_2_subject/financail_accounting_&_management_dart/financial_accounting_unit_wise.dart';


class FinancialAccountingAndmanagement extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FinancialAccountingAndmanagementState();
}

class _FinancialAccountingAndmanagementState extends State<FinancialAccountingAndmanagement> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Financial Accounting And Management",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 28,fontWeight: FontWeight.bold,),)),
              ),
             ...
             const SizedBox(
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>FinancialAccountingUnitWise() ));
              },),
              const SizedBox(
                height: 18,
              ),
