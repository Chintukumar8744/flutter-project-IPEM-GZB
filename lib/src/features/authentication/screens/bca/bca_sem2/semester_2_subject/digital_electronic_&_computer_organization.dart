...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem2/semester_2_subject/Digital_electronic_&_computer_orginization/digital_electronic_unit_wise.dart';


class DigigalElectronic extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _DigigalElectronicState();
}

class _DigigalElectronicState extends State<DigigalElectronic> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Digigal Electronic and Computre Funtimantal ",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 28,fontWeight: FontWeight.bold,),)),
              ),
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>DigigalElectronicandComputreFuntimantal() ));
              },),
              SizedBox(
                height: 18,
              ),
