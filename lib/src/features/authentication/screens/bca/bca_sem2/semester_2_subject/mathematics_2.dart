...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem2/semester_2_subject/mathematics_2/mathematics_2_unit_wise.dart';


class Mathematics_2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Mathematics_2State();
}

class _Mathematics_2State extends State<Mathematics_2> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Mathamatics II",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 28,fontWeight: FontWeight.bold,),)),
              ),
              ...
              Recbutton2(btnName: "Notes", bordercolor: Colors.red,backgroundcolor:Colors.white,callBack: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) =>Mathematics2UnitWise() ));
              },),
              const SizedBox(
                height: 18,
              ),
