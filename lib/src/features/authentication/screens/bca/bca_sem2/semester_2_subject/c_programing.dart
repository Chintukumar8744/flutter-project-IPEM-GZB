...
import 'package:ipemnotesapp/src/features/authentication/screens/bca/bca_sem2/semester_2_subject/c_programming/c_programming_unit_wise.dart';


class Cprogramming extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CprogrammingState();
}
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("C programming ",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 28,fontWeight: FontWeight.bold,),)),
              ),
