...
class DigigalElectronicandComputreFuntimantal extends StatefulWidget {
  const DigigalElectronicandComputreFuntimantal({super.key});

  @override
  State<DigigalElectronicandComputreFuntimantal> createState() => _DigigalElectronicandComputreFuntimantalState();
}

class _DigigalElectronicandComputreFuntimantalState extends State<DigigalElectronicandComputreFuntimantal> {
  @override
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Center(child: Text("Digigal Electronic and Computre Funtimantal",textAlign: TextAlign.center,style: TextStyle(color: Colors.deepPurple,fontSize: 30,fontWeight: FontWeight.bold),)),
              ),
              ...
              Recbutton2(btnName: "Unit 5", bordercolor: Colors.redAccent,backgroundcolor:Colors.white,callBack: (){
